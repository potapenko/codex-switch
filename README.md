...
<img src="docs/images/codexswitch-menu-masked.png" alt="Masked CodexSwitch menu showing five accounts, quota remaining, reset times, and reset credits" width="432">
